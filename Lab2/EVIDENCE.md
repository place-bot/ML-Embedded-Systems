...
After shutdown, the student requested a shorter AI Attribution Appendix. It was condensed from 524 to 161 words on OMEN; the analysis page remains textually and visually identical. The current PDF, LaTeX and document hashes in this repository reflect that revision. The immutable Pi archive retains the earlier appendix version; all original experiment evidence remains unchanged.
